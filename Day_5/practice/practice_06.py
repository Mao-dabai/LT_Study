...
class GoodList(object):
    ...
    view_btn = (By.XPATH,"//span[text()='dell电脑-x']/../../td[13]/a[1]")
    del_btn = (By.XPATH,"//span[text()='dell电脑-x']/../../td[13]/a[4]")
...
add.enter_goods_price(r'D:\LT_Study\Day_5\picture\dell电脑.png')
